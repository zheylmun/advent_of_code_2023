...
fn is_gear(input: char) -> bool {
    input == '*'
}

fn parse_schematic(input: &str) -> Vec<SchematicRow> {
    let mut schematic = Vec::new();
    for line in input.lines() {
        let mut items = Vec::new();
        for (index, character) in line.chars().enumerate() {
            if is_period(character) {
                continue;
            } else if is_symbol(character) {
                items.push(SchematicItem::Symbol {
                    index,
                    symbol: character,
                })
            } else if character.is_ascii_digit() {
                items.push(SchematicItem::Number {
                    start_index: index,
                    end_index: index,
                    value: character.to_digit(10).unwrap(),
                });
            } else {
                panic!("Invalid character in input: {}", character)
            }
        }
        let mut index = 0;
                    ...
                    if index + 1 < items.len() {
                        match items[index + 1] {
                            SchematicItem::Number {
                                ...
                                if next_start_index == end_index + 1 {
                                    items[index] = SchematicItem::Number {
                                        start_index,
                                        end_index: next_end_index,
        ...
        schematic.push(SchematicRow { items })
    }
    schematic
}

pub fn day_3_pt_1() -> String {
    let mut sum = 0;
...
static _SAMPLE_INPUT: &str = "467..114..
...*......
..35..633.
......#...
617*......
...
static INPUT : &str = "....411...............838......721.....44..............................................607..................................................
